...
eval(parse(text=input))
cell2 = isolate_lineage_sub(cds, paste0(lineage, "_2"), sel_clusters = sel_clusters, start_regions = start_regions, starting_clusters = starting_clusters, subset = subset, N = N, cl = cl)
